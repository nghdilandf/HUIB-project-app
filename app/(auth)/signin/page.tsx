      ...
      <div className="flex-1 flex items-center justify-center sticky top-0 h-screen bg-white z-10">
        <div className="rounded-lg shadow-lg p-8 w-full max-w-md">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              <label
                ...
                className={`absolute left-3 top-2 text-gray-500 bg-white px-1 transition-all duration-200 pointer-events-none ${focus.username || form.username ? 'text-xs -top-2.5 left-2 text-[#ff2c2c] scale-90' : 'text-base top-4'}`}
              >
                Username
              </label>
            </div>
            ...
            <div className="relative">
              ...
              <label
                htmlFor="signup-town"
                className={`absolute left-3 top-2 text-gray-500 bg-white px-1 transition-all duration-200 pointer-events-none ${focus.town || form.town ? 'text-xs -top-2.5 left-2 text-[#ff2c2c] scale-90' : 'text-base top-4'}`}
              >
                Town
              </label>
            </div>
            ...
            <div className="relative">
              ...
              <label
                htmlFor="signup-city"
                className={`absolute left-3 top-2 text-gray-500 bg-white px-1 transition-all duration-200 pointer-events-none ${focus.city || form.city ? 'text-xs -top-2.5 left-2 text-[#ff2c2c] scale-90' : 'text-base top-4'}`}
              >
                City
              </label>
            </div>
            ...
            <div className="relative">
              ...
              <label
                htmlFor="confirm"
                className={`absolute left-3 top-2 text-gray-500 bg-white px-1 transition-all duration-200 pointer-events-none ${focus.confirm || form.confirm ? 'text-xs -top-2.5 left-2 text-[#ff2c2c] scale-90' : 'text-base top-4'}`}
              >
                Confirm Password
              </label>
              <button
          ...
          <div className="mt-4 text-center text-sm">
            ...
            <a href="/login" className="text-[#ff2c2c] underline">Sign In</a>
          </div>
        </div>
      </div>
